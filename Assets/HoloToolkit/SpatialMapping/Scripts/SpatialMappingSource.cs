...
namespace HoloToolkit.Unity.SpatialMapping
{
    public class SpatialMappingSource : MonoBehaviour
    {
        ...
        protected virtual Material NewMaterial { get { return SpatialMappingManager.Instance.NewMaterial; } }
            ...
            )
        {
            ...
            if (SpatialMappingManager.Instance.materialsChangeColor.ContainsKey(surfaceObject.Object.name))
            {
                surfaceObject.Renderer.sharedMaterial = NewMaterial;
            }
            else
            {
