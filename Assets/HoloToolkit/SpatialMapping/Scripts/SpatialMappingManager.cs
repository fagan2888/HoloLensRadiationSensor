...
namespace HoloToolkit.Unity.SpatialMapping
{
    ...
    public partial class SpatialMappingManager : Singleton<SpatialMappingManager>
    {
        ...
        public Dictionary<string, bool> materialsChangeColor = new Dictionary<string, bool>();
        ...
        public Material SurfaceMaterial
        {
            ...
            set
            {
                if (value != surfaceMaterial)
                {
                    ...
                    if (materialsChangeColor.ContainsKey(surfaceMaterial.name)) {
                        SetSurfaceMaterial(newMaterial);
                    } else
                    {
